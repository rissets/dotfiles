return {
	...
	dependencies = {
		...
		'3rd/image.nvim', -- optional image suport in preview windows: See ` Preview Mode` for more information
		{
	...
	config = function()
		...
		require('neo-tree').setup {
			close_if_last_window = false, -- Close neo-tree if it is the last windo left in the tab
			popup_border_style = 'rounded',
			enable_git_status = true,
			enable_diagnostics = true,
			-- enable_normal_mode_for_inputs = false,
			open_files_do_not_replace_types = { 'termianl', 'trouble', 'qf' },
			...
			-- see: ':h neo-tree-custom-commands-global' for more information
			commands = {},
			window = {
				position = 'left',
				width = 40,
